...
-- Insert dummy medical records with valid record types
...
((SELECT id FROM patients WHERE patient_id = 'P-2024-0002'), 'Treatment Plan', 'Contact Dermatitis Management', 'Mild allergic reaction to new skincare product. Recommended discontinuation and topical treatment.', 'Dr. Michael Rodriguez', '2024-01-08', NULL),
...
((SELECT id FROM patients WHERE patient_id = 'P-2024-0003'), 'Treatment Plan', 'Hypertension Management', 'Blood pressure 145/95. Started on ACE inhibitor. Follow-up in 4 weeks.', 'Dr. Jennifer Kim', '2024-01-05', NULL),
((SELECT id FROM patients WHERE patient_id = 'P-2024-0004'), 'Test Result', 'Pap Smear', 'Normal cervical cytology. No abnormal cells detected. Next screening in 3 years.', 'Dr. Lisa Thompson', '2024-01-12', NULL),
...
((SELECT id FROM patients WHERE patient_id = 'P-2024-0006'), 'Assessment', 'Anxiety Disorder Evaluation', 'Generalized anxiety symptoms. Started cognitive behavioral therapy sessions.', 'Dr. Amanda Foster', '2024-01-09', NULL),
...
((SELECT id FROM patients WHERE patient_id = 'P-2024-0008'), 'Vaccination', 'Annual Flu Shot', 'Administered seasonal influenza vaccine. No adverse reactions noted.', 'Dr. Emily White', '2024-01-13', NULL);
