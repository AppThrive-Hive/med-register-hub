...
((SELECT id FROM patients WHERE patient_id = 'P-2024-0002'), 'Diagnosis', 'Contact Dermatitis', 'Mild allergic reaction to new skincare product. Recommended discontinuation and topical treatment.', 'Dr. Michael Rodriguez', '2024-01-08', NULL),
...
((SELECT id FROM patients WHERE patient_id = 'P-2024-0006'), 'Assessment', 'Anxiety Disorder', 'Generalized anxiety symptoms. Started cognitive behavioral therapy sessions.', 'Dr. Amanda Foster', '2024-01-09', NULL),
